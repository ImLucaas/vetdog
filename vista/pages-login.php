          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <h1 class="mb-4 text-xl font-semibold text-gray-700 dark:text-gray-200">
                Plataforma web - Clinica de Animales Menores FMV - UNMSM
              </h1>
              <?php
    if(isset($errMsg)){
...
?>
              <label class="block text-sm">
                ...
                <input
                  ...
                  placeholder="Ingrese su usuario" name="usuario" value="<?php if(isset($_POST['usuario'])) echo $_POST['usuario'] ?>" autocomplete="off"
                />
              </label>
