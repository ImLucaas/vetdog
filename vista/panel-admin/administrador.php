<?php
    ...
    echo "Session 'cargo' is not set.";
    header('location: ../pages-login');
    exit();
  } else {
    echo "Session 'cargo' is set to: " . $_SESSION['cargo'];
  }
?>
<!DOCTYPE html>
<html>
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="administrador"> CLINICA DE ANIMALES MENORES FMV - UNMSM </a>
            </div>
