...
<?php if(count($data)>0):?>
    <?php foreach($data as $d):?>
                        <form method="POST"  autocomplete="off" action="editarRegistro?id=<?php echo $d->id_vet; ?>">
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <label class="control-label">DNI del personal veterinario</label>
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Nombre del personal veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Apellido del personal veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Cargo del personal veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="direcc" value="<?php echo $d->direcc; ?>" required class="form-control" placeholder="Cargo..." />
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-3">
                                    <label class="control-label">Sexo del personal veterinario</label>
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Correo del personal veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Telefono movil del personal veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-3">
                                    <label class="control-label">Telefono fijo del personal veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-4">
                                    <label class="control-label">Usuario del personal veterinario</label>
                                    <div class="form-group">
                                        <div class="form-line">
