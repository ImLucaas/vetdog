            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                REGISTRO DE PERSONAL VETERINARIO
                                <small>Registra cualquier personal veterinario...</small>
                            </h2>
                        </div>
                    ...
                    <div class="body">
                        <form method="POST"  autocomplete="off" enctype="multipart/form-data">
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <label class="control-label">DNI del personal<span class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-6">
                                    <label class="control-label">Nombre del personal<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="nomvet" required class="form-control" placeholder="Nombre del personal..." />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <label class="control-label">Apellido del personal<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="apevet" required class="form-control" placeholder="Apellido del personal..." />
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-6">
                                     <label class="control-label">Cargo del personal<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="direcc" required class="form-control" placeholder="Cargo del personal..." />
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-5">
                                    <label class="control-label">Sexo del personal</label>
                                ...
                                <div class="col-sm-4">
                                      <label class="control-label">Correo del personal<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="email" name="correo" required class="form-control" placeholder="Correo del personal..." />
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-3">
                                    <label class="control-label"> Telefono movil del personal<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="movil" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="9" required class="form-control" placeholder="Telefono del personal..." />
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-4">
                                    <label class="control-label"> Telefono fijo del personal<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="fijo" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="6" required class="form-control" placeholder="Telefono fijo del personal..." />
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-4">
                                     <label class="control-label"> Usuario del personal<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-4">
                                    <label class="control-label"> Contraseña del personal<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                ...
                                <div class="col-sm-4">
                                    <label class="control-label"> Imagen del personal</label>
                                    <div class="form-group">
                                        <div class="form-line">
