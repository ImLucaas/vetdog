    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../vista/panel-admin/administrador"> CLINICA DE ANIMALES MENORES FMV - UNMSM </a>
            </div>
...
try
{
    $bdd = new PDO('mysql:host=localhost;dbname=vetdog;charset=utf8', 'root', 'pelos2012');
}
catch(Exception $e)
{
