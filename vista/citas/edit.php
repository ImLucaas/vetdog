            ...
            <div class="form-group">
                <div class="form-line">
                    <input type="text" name="title" value="<?php echo $d->title; ?>" class="form-control" placeholder="Nombre de la cita..." />
                                ...
                                <div class="col-sm-4">
                                    <label class="control-label">Personal Veterinario</label>
    ...
    <div class="row clearfix">
        <div class="col-sm-3">
            ...
            <div class="input-group">
                ...
                <div class="form-line">
                    <input type="text" value="<?php echo $d->precio; ?>" name="precio" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control money-euro" placeholder="Precio... Ex: S/.">
                </div>
            </div>
        </div>
