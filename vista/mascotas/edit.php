...
<?php         
function connect(){
return new mysqli("localhost","root","pelos2012","vetdog");
}
$con = connect();
$id = $_GET['id'];
$sql = "SELECT pet.id_pet, pet.nomas, pet_type.id_tiM, pet_type.noTiM, raza.id_raza, raza.nomraza, pet.dni_due, pet.nom_due, pet.ape_due, pet.sexo, pet.edad, pet.tamano, pet.peso, pet.obser, pet.estado, pet.fere FROM pet INNER JOIN pet_type ON pet.id_tiM =  pet_type.id_tiM INNER JOIN raza ON pet.id_raza =raza.id_raza WHERE id_pet= '$id'";
$query  =$con->query($sql);
$data =  array();
if($query){
...
<?php if(count($data)>0):?>
    <?php foreach($data as $d):?>
                        <form method="POST"  autocomplete="off" action="editarRegistro?id=<?php echo $d->id_pet; ?>">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $d->dni_due; ?>" id="documentodni"  name="dni_due"  onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" maxlength="8" required class="form-control" placeholder="DNI del cliente..." />
                                        </div>
                                    </div>
                    ...
                    <label class="control-label">Nombre del cliente<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $d->nom_due;?>" id="nombres" name="nom_due" required class="form-control" placeholder="Nombre del cliente..." />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <label class="control-label">Apellido del cliente<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $d->ape_due;?>" id="apellidoPaterno" name="ape_due" required class="form-control" placeholder="Apellido del cliente..." />
                                        </div>
                                    </div>
                            </div>
      
                                <div class="col-sm-4">
                                    <label class="control-label">Distrito del dueño</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text" value="<?php echo $d->tamano; ?>" name="tamano" maxlength="20" required class="form-control" placeholder="Distrito del dueño..." />
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-4">
                                    <label class="control-label">Celular del dueño</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" value="<?php echo $d->peso; ?>" name="peso" maxlength="9" required class="form-control" placeholder="Celular del dueño..." />
                                        </div>
                                    </div>
                                </div>
