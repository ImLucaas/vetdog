            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <label class="control-label">Nombre del cliente<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="nombres" name="nom_due" required class="form-control" placeholder="Nombre del cliente..." />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <label class="control-label">Apellido del cliente<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" id="apellidoPaterno" name="ape_due" required class="form-control" placeholder="Apellido del cliente..." />
                                        </div>
                                    </div>
                            </div>
      
                                <div class="col-sm-4">
                                    <label class="control-label">Distrito del dueño<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                        <input type="text" name="tamano" maxlength="20" required class="form-control" placeholder="Distrito del dueño..." />
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-8">
                                    <label class="control-label">Celular del dueño<span class="text-danger">*</span></label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="peso" maxlength="9" required class="form-control" placeholder="Celular del dueño..." />
                                        </div>
                                    </div>
                                </div>
...
if (isset($_POST["agregar"])) {
    ...
    // Realizamos la consulta para saber si ya existe el registro
    $check_query = "SELECT * FROM pet WHERE nomas='$nomas' AND dni_due='$dni_due' AND nom_due='$nom_due' AND ape_due='$ape_due'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $sql2 = "INSERT INTO pet (nomas, id_tiM, id_raza, dni_due, nom_due, ape_due, sexo, edad, tamano, peso, obser, estado) 
                 VALUES ('$nomas', '$id_tiM', '$id_raza', '$dni_due', '$nom_due', '$ape_due', '$sexo', '$edad', '$tamano', '$peso', '$obser', '$estado')";
